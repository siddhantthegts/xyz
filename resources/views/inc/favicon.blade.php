...
<link rel="mask-icon" href="{{ config('app.url') }}/favicon/safari-pinned-tab.svg" color="#5bbad5">
<link rel="shortcut icon" href="{{ config('app.url') }}/favicon/favicon.ico">
<meta name="msapplication-TileColor" content="#ffffff">
<meta name="msapplication-config" content="{{ config('app.url') }}/favicon/browserconfig.xml">
