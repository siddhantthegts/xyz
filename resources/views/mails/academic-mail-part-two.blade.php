...
<body>
    <table
        style="border:4px solid #efefef;border-collapse:collapse;width:660px;margin:0 auto;background:#fff;font-family:sans-serif">
        <tbody>
            <tr>
                <td style="padding:30px 30px 20px">
                    ...
                    <table
                        style="border:4px solid #000;border-collapse:collapse;width:660px;margin:0 auto;background:#fff;font-family:sans-serif;font-size:24px">
